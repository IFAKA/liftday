...
export const MUSCLE_SMV_SCORE: Record<MuscleGroup, number> = {
  ...
  forearms:    5, // visible wrist-to-arm transition; high overlap, lower ceiling
...
export const EXERCISE_MUSCLE_CONTRIBUTIONS: Partial<Record<ExerciseKey, MuscleContribution>> = {
  ...
  trx_curl: { biceps: 1 },
  trx_reverse_curl_assisted: { forearms: 1, biceps: 0.35 },
  trx_reverse_curl: { forearms: 1, biceps: 0.35 },
  ...
  lat_pulldown: { lats: 1, biceps: 0.3, upper_back: 0.2, forearms: 0.12 },
  neutral_grip_pulldown: { lats: 1, biceps: 0.3, upper_back: 0.2, forearms: 0.15 },
  pullup: { lats: 1, biceps: 0.35, upper_back: 0.25, forearms: 0.2 },
  cable_row: { mid_back: 1, lats: 0.4, biceps: 0.25, rear_delt: 0.2, forearms: 0.1 },
  one_arm_cable_lat_row: { lats: 1, mid_back: 0.35, biceps: 0.2, forearms: 0.1 },
  chest_supported_row: { mid_back: 1, lats: 0.4, biceps: 0.25, rear_delt: 0.3, forearms: 0.1 },
  machine_row: { mid_back: 1, lats: 0.4, biceps: 0.25, rear_delt: 0.25, forearms: 0.1 },
  braced_cable_row: { mid_back: 1, lats: 0.4, biceps: 0.25, rear_delt: 0.25, forearms: 0.1 },
  barbell_row: { mid_back: 1, lats: 0.45, biceps: 0.25, rear_delt: 0.25, hamstrings: 0.15, forearms: 0.15 },
  ...
  db_curl: { biceps: 1, forearms: 0.15 },
  db_incline_curl: { biceps: 1, forearms: 0.1 },
  preacher_curl: { biceps: 1, forearms: 0.1 },
  barbell_curl: { biceps: 1, forearms: 0.18 },
