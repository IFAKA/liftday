...
export const PUSH_EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    instruction: 'Face anchor, lean back 30°, overhand grip. Pull handles up to chin, elbows high and flared wide. Pause at top. Directly loads side delts and upper traps.',
    workoutType: 'push',
  },
  {
    key: 'trx_shrug',
    ...
    unit: 'reps',
    primaryMuscle: 'side_delt',
    instruction: 'Face anchor, lean back 45°, arms straight. Keeping arms extended, elevate shoulders as high as possible. Hold 1 sec at top, lower slowly. Upper trap isolation for neck-to-shoulder strength.',
    workoutType: 'push',
  },
  {
    key: 'pushup',
...
export const PULL_EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    unit: 'reps',
    primaryMuscle: 'biceps',
    instruction: 'Face anchor, lean back to 45°, palms facing down, arms extended. Curl handles toward shoulders keeping wrists neutral. Full load version. Brachioradialis and forearm extensor work.',
    workoutType: 'pull',
  },
];
...
export const LEGS_EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    unit: 'seconds',
    primaryMuscle: 'neck',
    instruction: 'Clasp hands behind head. Press head backward against hand resistance. Hold 10 seconds per rep. Builds posterior neck extensors with controlled loading.',
    workoutType: 'legs',
  },
];
...
export const GYM_PUSH_EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    unit: 'weighted',
    primaryMuscle: 'side_delt',
    instruction: 'Slight elbow bend, lift arms to shoulder height at sides. Lead with elbows not hands — pour water from a jug. Pause 1 sec at top. Lower slowly (3 sec). Primary side delt isolation.',
...
export const GYM_PULL_EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    instruction: 'Overhand grip, elbows pinned. Curl without wrist bend, pause near the top, lower slowly. Low-dose brachioradialis and forearm extensor work.',
    workoutType: 'pull',
  },
  {
    key: 'db_wrist_extension',
    name: 'DUMBBELL WRIST EXTENSION',
    unit: 'weighted',
    primaryMuscle: 'forearms',
    instruction: 'Forearm supported on thigh or bench, palm down. Extend the wrist smoothly, pause briefly, then lower under control. Keep it light and stop before wrist or elbow irritation.',
    workoutType: 'pull',
  },
];
...
export const PROGRESS_PHOTOS_KEY = 'liftday_progress_photos';
