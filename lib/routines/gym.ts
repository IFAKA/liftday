  ...
  tierChains: [
    {
      ...
      prescription: prescription(4, 6, 10, '3 min', 'Upper chest first. Deep controlled reps, no grind.'),
    },
    {
      slotId: 'push_a_seated_db_shoulder',
      workoutType: 'push_a',
      fixed: true,
      priority: 'high',
      selectedExercise: 'db_shoulder_press',
      alternatives: ['barbell_ohp'],
      exercises: ['db_shoulder_press'],
      prescription: prescription(3, 6, 10, '2.5 min', 'Seated press. Keep reps clean and stop before compensation.'),
    },
    {
      ...
      prescription: prescription(4, 12, 20, '90 sec', 'Side delt, not traps. Lead with elbow.', '0-1 RIR'),
    },
    {
      ...
      exercises: ['cable_fly'],
      prescription: prescription(3, 10, 15, '90 sec', 'Low-to-high arc. Squeeze without shoulder roll.', '1 RIR'),
    },
    {
    ...
    },
    {
      ...
      prescription: prescription(3, 12, 15, '90 sec', 'Arms long. Drive hands to hips.', '1 RIR'),
    },
    {
      ...
      prescription: prescription(4, 15, 25, '90 sec', 'Wide sweep. Rear delts only.', '0-1 RIR'),
    },
    {
      ...
      prescription: prescription(3, 8, 15, '90 sec', 'Elbows pinned. Full stretch.', '0-1 RIR'),
    },
    {
    ...
    },
    {
      ...
      prescription: prescription(3, 6, 10, '3 min', 'Stable press. Do not chase failure.'),
    },
    {
    ...
    },
    {
      ...
      exercises: ['cable_row'],
      prescription: prescription(3, 8, 12, '2.5 min', 'Tall chest. Pull through elbows.'),
    },
    {
    ...
    },
    {
      ...
      prescription: prescription(3, 15, 25, '75 sec', 'Second lateral slot. Stop when traps take over.', '0-1 RIR'),
    },
    {
      ...
      exercises: ['db_shrug'],
      prescription: prescription(3, 10, 15, '2 min', 'Neck-to-shoulder thickness. No rolling.'),
    },
    {
      ...
      alternatives: ['db_curl'],
      exercises: ['cable_curl'],
      prescription: prescription(3, 10, 15, '90 sec', 'Cable tension. Elbows pinned.', '0-1 RIR'),
    },
    {
      ...
      alternatives: ['db_curl', 'cable_curl'],
      exercises: ['hammer_curl'],
      prescription: prescription(3, 10, 15, '90 sec', 'Hammer or reverse curl for brachialis and forearm thickness.', '0-1 RIR'),
    },
    {
      ...
      alternatives: ['cable_tricep_pushdown'],
      exercises: ['overhead_tricep_ext'],
      prescription: prescription(3, 10, 15, '90 sec', 'Long-head stretch. Stop for elbow irritation.', '0-1 RIR'),
    },
    {
