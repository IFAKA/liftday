...
export const gymRoutine: RoutineConfig = {
  ...
  tierChains: [
    ...
    },
    {
      ...
      exercises: ['cable_row'],
      prescription: prescription(2, 8, 12, '2.5 min', 'Tall chest. Pull through elbows.'),
    },
    {
    ...
    },
    {
      ...
      prescription: prescription(2, 15, 25, '75 sec', 'Second lateral slot. Stop when traps take over.', '0-1 RIR'),
    },
    {
