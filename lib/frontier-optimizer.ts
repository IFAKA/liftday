...
const SMV_ALLOCATION_CANDIDATES: FrontierCandidate[] = [
  ...
  { slotId: 'pull_a_row', workoutType: 'pull_a', fixed: true, priority: 'critical', order: 20, minSets: 2, maxSets: 3, exercises: ['braced_cable_row', 'cable_row', 'chest_supported_row', 'barbell_row'], fatigueClass: 'stable_compound', localFatigue: 0.9, systemicFatigue: 0.25, jointFatigue: 0.25, progressionReliability: 0.85, smvRoi: 1.0, rationale: 'Rows protect posture/frame while braced options avoid wasting recovery on low-back fatigue.', prescription: prescription(8, 12, '2.5 min', 150, 'Pull through elbows. Keep torso quiet.') },
  ...
  { slotId: 'legs_hinge', workoutType: 'legs_maintenance', fixed: true, priority: 'support', order: 20, minSets: 2, maxSets: 3, exercises: ['romanian_deadlift', 'leg_curl_machine'], fatigueClass: 'systemic_lower', localFatigue: 1.0, systemicFatigue: 0.75, jointFatigue: 0.5, progressionReliability: 0.75, smvRoi: 0.4, rationale: 'Hamstrings and glutes are preserved with the minimum productive dose to avoid systemic spillover.', prescription: prescription(6, 10, '2.5-3 min', 165, 'Hamstring stretch. Leave low back fresh.') },
  ...
  { slotId: 'pull_b_row', workoutType: 'pull_b', fixed: true, priority: 'critical', order: 20, minSets: 2, maxSets: 3, exercises: ['braced_cable_row', 'cable_row', 'chest_supported_row', 'barbell_row'], fatigueClass: 'stable_compound', localFatigue: 0.9, systemicFatigue: 0.25, jointFatigue: 0.25, progressionReliability: 0.85, smvRoi: 1.0, rationale: 'Horizontal pulling keeps upper-back posture without chasing unnecessary back volume.', prescription: prescription(8, 12, '2.5 min', 150, 'Chest tall. Pull through elbows.') },
  ...
  { slotId: 'delts_arms_lateral', workoutType: 'delts_arms', fixed: true, priority: 'critical', order: 10, minSets: 3, maxSets: 4, exercises: ['db_lateral_raise', 'cable_lateral_raise', 'machine_lateral_raise'], fatigueClass: 'isolation', localFatigue: 0.7, systemicFatigue: 0.05, jointFatigue: 0.35, progressionReliability: 0.9, smvRoi: 1.25, rationale: 'Saturday is a small specialization dose, not a junk-volume dump; side delts remain first because they are priority and fatigue-sensitive.', prescription: prescription(12, 20, '60-90 sec', 75, 'Pure side delts. Quality over load.', '0-1 RIR') },
