  ...
  return (
    ...
    >
      ...
      <div className="w-full shrink-0 z-10" onClick={(e) => e.stopPropagation()}>
        <Button
          onClick={onComplete}
          className="w-full btn-mobile-accessible rounded-full bg-white/10 text-white active:scale-95 transition-[background-color,border-color,color,transform] duration-150 ease-[var(--ease-out-ui)] font-black uppercase tracking-widest border border-white/5"
        >
