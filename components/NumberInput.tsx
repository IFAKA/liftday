    ...
    <div className="flex flex-col items-center justify-center w-full flex-1 relative min-h-0">
      ...
      <div className="absolute inset-0 flex z-20">
        <Button
          ...
          aria-label="Decrease"
        >
          <Minus className="icon-xl text-white group-active:opacity-80 transition-opacity" />
        </Button>
        ...
        <Button
          ...
          aria-label="Increase"
        >
          <Plus className="icon-xl text-white group-active:opacity-80 transition-opacity" />
        </Button>
      </div>
    </div>
  );
